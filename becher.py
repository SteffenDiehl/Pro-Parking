...
def parkhaus_oberflaeche():
    global carcounter, starttime, revenue, Parkplatz_list_extra_vorhanden, Parkplatz_list_vorhanden
    runningspiel = True
    farbe = BLACK
    screen.fill(farbe)
    genbackground(0)
